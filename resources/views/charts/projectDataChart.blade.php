<div class="container">
   ...
   <div class="card card-success col-md-6">
        <div class="card-header">
            <h4 class="card-title">{{$project->name}} Project Visit Status Chart/Graph</h4>
        </div>
        <div class="card-body">
    ...
    <div class="card card-success col-md-6">
        <div class="card-header">
            <h4 class="card-title">{{$project->name}} Project, Pending and On Window Visit Status Chart/Graph</h4>
        </div>
        <div class="card-body">
