...
unset($__errorArgs, $__bag); ?>
                        ...
                        <label for="user_active" class="col-md-4 col-form-label text-md-right">User Active</label>
                            ...
                            <select id="user_active" data-placeholder="user_active" class="form-control tagsselector" name="user_active">  
                                        <option value="<?php echo e(old('user_active')); ?>"><?php echo e(old('user_active')); ?> </option>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Visitcallender\resources\views/users/create.blade.php ENDPATH**/ ?>