...
} elseif ($_instance->childHasBeenRendered('BiAn6gi')) {
    $componentId = $_instance->getRenderedChildComponentId('BiAn6gi');
    $componentTag = $_instance->getRenderedChildComponentTagName('BiAn6gi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BiAn6gi');
} else {
    $response = \Livewire\Livewire::mount('home.scheduled-visits');
    $html = $response->html();
    $_instance->logRenderedChild('BiAn6gi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
} elseif ($_instance->childHasBeenRendered('okqsJPY')) {
    $componentId = $_instance->getRenderedChildComponentId('okqsJPY');
    $componentTag = $_instance->getRenderedChildComponentTagName('okqsJPY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('okqsJPY');
} else {
    $response = \Livewire\Livewire::mount('home.weekly-appointments');
    $html = $response->html();
    $_instance->logRenderedChild('okqsJPY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
