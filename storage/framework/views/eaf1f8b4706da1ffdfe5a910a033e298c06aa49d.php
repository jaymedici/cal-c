...
<div class="row">
    <div class="card card-secondary card-outline col-md-6 offset-md-3">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('user.updateProfile')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Visitcallender\resources\views/users/changePassword.blade.php ENDPATH**/ ?>