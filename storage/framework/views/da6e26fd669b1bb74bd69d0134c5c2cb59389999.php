...
unset($__errorArgs, $__bag); ?>" id="site_id">
                            ...
                            <?php $__currentLoopData = $project->sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
